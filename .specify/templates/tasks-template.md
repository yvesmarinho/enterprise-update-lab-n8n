...
**Tests**: The examples below include test tasks. For infrastructure/runtime
changes, validation and evidence tasks are MANDATORY.
...
### Constitution Compliance Tasks (MANDATORY)

- [ ] TXXX Define rollback trigger and recovery steps in docs/runbook artifacts
- [ ] TXXX Define backup and restore drill per checkpoint in docs/runbook artifacts
- [ ] TXXX Capture pre-check and post-check execution evidence in docs/
- [ ] TXXX Validate compatibility gates (runtime, storage, credentials,
